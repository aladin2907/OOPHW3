...
while True:
    print("1. Add new Plant\n" +
          ...
          "8. Get all salons\n" +
          "9. Get Salon by Id\n" +
          "10. Get Employees by Salons\n" +
          "11. Get Employees by Plants\n"
        )
    ...
    if flag == 1:
        ...
        salon_number = int(input('Input salon number: '))
        name = 'type_of_work'
        salon.find_by(salon_number, name)

    elif flag == 11:
        plant_name = input('Input plant name: ')
        name = 'type_of_work'
        print(Employee.find_by(plant_name, name))